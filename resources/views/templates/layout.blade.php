    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="{{route('list_book')}}">Sách</a>
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('list_user')}}">Tài Khoản</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="{{route('list_review')}}">Đánh Giá</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="{{route('list_promotion')}}">Quản Lý Khuyến Mãi</a>
            </li>
        </ul>
    </div>
